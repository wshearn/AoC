...
class Main {
	public static function main() {
		...
		for (_ in 0...200) {
			...
			var outterCount:Int = 0;
			for (x in 0...5) {
				outterCount += data[whichData][lowestKey][0][x];
				outterCount += data[whichData][lowestKey][4][x];
				outterCount += data[whichData][lowestKey][x][0];
				outterCount += data[whichData][lowestKey][x][4];
			}
